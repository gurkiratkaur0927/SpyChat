...
def create():
    ...
    while True:
        ...
        if (new_age < 12 or new_age > 50):
            print "\t\tage not accepted. Please enter a age b/w (12-50) "
            continue
        else:
            break
    buff = True
...
def read_message(active):
    ...
    if words >=100:
        print "%s  deleted from ur friend list(speaks too much)" % active.friends[sel]
